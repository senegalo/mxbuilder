        ...
        $.extend(mxBuilder.FBLikeComponent.prototype, new mxBuilder.Component(), {
            ...
            rebuild: function rebuild(element) {
                ...
                switch (this.counterPosition) {
                    case "standard":
                        width = this.action === "recommend" ? 265 : 225;
                        height = 35;
                        break;
                    case "button_count":
                        width = this.action === "recommend" ? 130 : 90;
                        height = 20;
                        break;
                    case "box_count":
                        width = this.action === "recommend" ? 98 : 50;
                        height = 65;
                        break;
                }
            ...
            revalidate: function revalidate(element) {
                ...
                var theHeight = theButton.attr("height");
                var theWidth = theButton.attr("width");
